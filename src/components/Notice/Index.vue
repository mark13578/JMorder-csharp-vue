    ...
    <el-popover placement="bottom" trigger="click" width="400px" popper-class="el-popover-pupop-user-news">
      ...
      <el-tabs v-model="noticeType">
        <el-tab-pane name="0">
            ...
            <el-scrollbar>
              <div class="content-box-item" v-for="item in noticeList">
                ...
                <!-- <div v-if="!readList.includes(item.noticeId)">
                  <el-button text @click="handleReadNotice(item)">已讀</el-button>
                </div> -->
              </div>
            </el-scrollbar>
          ...
          <div class="foot-box">
            <div class="read" @click="onAllReadClick" v-show="dotNumInfo.noticeNum > 0">標記當前頁已讀</div>
        ...
        <el-tab-pane name="1">
          ...
          <div class="foot-box">
            <div class="read" @click="onAllReadClick" v-if="dotNumInfo.chatNum > 0">標記當前頁已讀</div>
          </div>
        </el-tab-pane>
        <el-tab-pane name="2">
          <template #label>
            <el-badge :show-zero="false" :value="dotNumInfo.sysMsgNum"> 系統 </el-badge>
          </template>
            ...
            <el-scrollbar>
              <div class="content-box-item" v-for="item in sysList">
                ...
                <div v-if="item.isRead == 0">
                  <el-button text @click="handleRead(item)">已讀</el-button>
                </div>
              </div>
          ...
          <div class="foot-box">
            <div class="read" @click="onAllReadClick" v-if="dotNumInfo.sysMsgNum > 0">標記當前頁已讀</div>
          </div>
        </el-tab-pane>
      </el-tabs>
    </el-popover>
